...
public class BoxPanel extends BedCardPanel {
	...
	public BoxPanel(BedCard bedcard, String title, int boxWidth, int boxHeight) {
		super(bedcard);
		this.title = title;
		this.width = boxWidth;
		...
		bottomLeftCorner = bedcard.getImageLoader().getImage("boxpanel/bottomLeftCorner.png");
		bottomRightCorner = bedcard.getImageLoader().getImage("boxpanel/bottomRightCorner.png");
		topLeftCorner = bedcard.getImageLoader().getImage("boxpanel/topLeftCorner.png");
		topRightCorner = bedcard.getImageLoader().getImage("boxpanel/topRightCorner.png");
